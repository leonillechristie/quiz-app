...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
	 ...
	 ?>
	 	<buttom type="button" data-toggle="modal" data-target="#myModalConfirm" class="btn btn-primary" style="float:right; margin-right: 11.5%; border-radius:5px">SAVE CHANGES</button>		
		</div>
	</header>
    ...
    <!-- MODAL REDIRECTION CONFIRMATION -->
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <h1 style="color:rgb(112,203,206); text-align:center"> Are you sure with these changes?<br><br>
		        	<p style="font-size:0.5em"><small>Don't worry! You can freely edit your quiz at any given point in time</small></p> </h1>
		      </div>
 		      <div class="modal-footer">
		      	<span class="fa fa-spinner fa-spin loadgif" hidden></span>
		      	<button type="button" class="btn btn-success redirbtn">Yes</button>
		        <button type="button" class="btn btn-danger closebtnn" data-dismiss="modal">No</button>
		      </div>
		    </div>
		  </div>
		</div>
		      ...
		      <div class="modal-body">
		        <form>
		        	...
		        	<div class="form-group text-center">
		        		...
		        		<input class="form-control rightAnswer answ" type="text" id="choice1">
		        		<label for="choice2">Other Choices</label>
		        		<input type="text" id="choice2" class="form-control wrongAnswer answ">
		        		<input type="text" id="choice3" class="form-control wrongAnswer answ">
		        		<input type="text" id="choice4" class="form-control wrongAnswer answ">

    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right" style="margin-left:65%" >
               <li class="introduc"><?php echo $_SESSION['fname']." ".$_SESSION['lname']; ?></li>
      ...
      <header class="quizformheader">
        <div class="container ">
          <div class="row">
            ...
            <div class="col-xs-6 signin text-right navbar-nav" style="margin-left:65%">
                <li class="introduc"> <?php echo $_SESSION['fname']." ".$_SESSION['lname']; ?></li>

      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="signUp.php" data-toggle="modal" data-target="#upModal">Sign-up</a></li>
            <li><a href="signIn.php" data-toggle="modal" data-target="#inModal">Sign in</a></li>
          </ul>
        </div><!--/.navbar-collapse -->
      </div>
    </div>
      ...
      <div class="container containernav">
        <div class="row rownav">
          ...
          <div class="col-xs-6 signin text-right navbar-nav">
            ...
            <a  data-toggle="modal" data-target="#upModal" class="linkk" style="cursor:pointer">Sign-Up</a> &nbsp; &nbsp;&nbsp;
            ...
            <div id="upModal" class="modal fade" role="dialog">
             ...
             <a  data-toggle="modal" data-target="#inModal" class="linkk"style="cursor:pointer">Sign-In</a> &nbsp; &nbsp;&nbsp;
              ...
              <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-left wow fadeInUp" data-wow-delay="1.4s">
                    <a class="btn btn-primary btn-lg scroll" href="#invite">Sign-up Now!</a>
                  </div>
                </div><!--End Button Row-->  
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form role="form" >
                  ...
                  <button type="button"class="btn btn-primary btn-lg" data-toggle="modal" data-target="#upModal">Sign-up</button>
                </form>
              </div>
            </div><!--End Form row-->
